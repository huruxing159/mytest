...
public class CustomServiceRefundmentAction extends ActionSupport implements UserAware {

	private static final long serialVersionUID = -7058675291261079671L;
	...
	public String execute() throws Exception {
		...
		this.order.setState(OrderState.WAIT_REFUNDMENT);
